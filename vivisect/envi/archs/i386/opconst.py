...
ADDRMETH_I=   0x00080000    #   Immediate data follows
ADDRMETH_J=   0x00090000    #   Immediate value is relative to EIP
ADDRMETH_M=   0x000A0000    #   MODRM mod field can refer only to memory
ADDRMETH_N=   0x000B0000    #   R/M field of MODRM selects a packed-quadword, MMX register
ADDRMETH_O=   0x000C0000    #   Displacement follows (without modrm/sib)
ADDRMETH_P=   0x000D0000    #   MODRM reg field defines MMX register
ADDRMETH_Q=   0x000E0000    #   MODRM defines MMX register or memory
ADDRMETH_R=   0x000F0000    #   MODRM mod field can only refer to register
ADDRMETH_S=   0x00100000    #   MODRM reg field defines segment register
ADDRMETH_U=   0x00110000    #   MODRM reg field defines test register
ADDRMETH_V=   0x00120000    #   MODRM reg field defines XMM register
ADDRMETH_W=   0x00130000    #   MODRM defines XMM register or memory
ADDRMETH_X=   0x00140000    #   Memory addressed by DS:rSI
ADDRMETH_Y=   0x00150000    #   Memory addressd by ES:rDI
...
OPTYPE_y   = 0x0F000000
OPTYPE_z   = 0x10000000     # 2/4   is this OPTYPE_z?  word for 16-bit operand size or doubleword for 32 or 64-bit operand-size
