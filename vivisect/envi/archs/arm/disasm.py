...
s_1_table = (
    ...
    (0b00000001100110000000000000000000, 0b00000001000000000000000000000000, IENC_UNDEF),
    (0,0, IENC_DP_IMM),
)
        ...
        if cond == COND_AL:
            if opcode in (INS_B, INS_BX):
                flags |= envi.IF_NOFALL
                    ...
                    opcode not in no_update_Rd ):        # FIXME: only want IF_NOFALL if it *writes* to PC!   tst is currently setting this off erroneously
